...
| `T-06` | Another sponsor, line, operator, or fee withdrawal consumes reserve. | Dedicated reserve ledger, role separation, earned-fee-only withdrawal. | `CAP-01`, `CAP-02`, `ROLE-01`; `CAP-01A/B`, `ROLE-01A` |
...
| `T-12` | Compromised deployer/operator retains authority after handoff. | Two-step ownership, explicit operator lifecycle, manifest assertions. | `ROLE-01`; `ROLE-01A/B` |

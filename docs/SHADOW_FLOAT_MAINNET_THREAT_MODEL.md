...
| `T-03` | Sponsor or owner declares default immediately after payment, terminating the agent before the agreed due time, or maturity/line expiry accidentally disables voluntary repayment before default. | Exact signed `dueAt`; objective inclusive boundary; no discretionary maturity flag; repayment explicitly remains available before, at, and after maturity and after line expiry until default executes. | `DEBT-01`, `EXIT-01`; `RED-03`, `DEBT-01A/B/D` |

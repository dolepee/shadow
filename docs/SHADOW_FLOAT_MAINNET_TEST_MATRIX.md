...
| `SIG-01A` | mutate sponsor, provider, endpoint, amount, max debt, fee, due time, epoch, terms, executor | `SIG-01` | Packet C table/fuzz |
...
| `SCOPE-01A` | ABI/source deny legacy owner credit, pools, yield, token, PolicyPool, Morpho, and Uniswap logic | `SCOPE-01` | Packet C boundary test/review |
